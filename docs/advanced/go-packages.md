...
To build an image, use [`pkg/build`](https://pkg.go.dev/github.com/LouisBrunner/ko/pkg/build), and publish it with [`pkg/publish`](https://pkg.go.dev/github.com/LouisBrunner/ko/pkg/publish).
...
import (
	...
	"github.com/LouisBrunner/ko/pkg/publish"
)
